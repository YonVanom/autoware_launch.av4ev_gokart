...
def launch_setup(context, *args, **kwargs):
    ...
    # Self crop box: removes the vehicle body from the simulated point cloud.
    # Input:  top/pointcloud_raw_ex  (absolute: /sensing/lidar/top/pointcloud_raw_ex, after isaac_sim_pointcloud_adapter)
...
def generate_launch_description():
    ...
    add_launch_arg("container_name", "pointcloud_preprocessor_container", "container name")
