...
def generate_launch_description():
    ...
    roboracer_offroad_sensor_kit_launch_share_dir = get_package_share_directory(
        "roboracer_offroad_sensor_kit_launch"
    )
    ...
    add_launch_arg(
        ...
        os.path.join(
            roboracer_offroad_sensor_kit_launch_share_dir,
            "config",
