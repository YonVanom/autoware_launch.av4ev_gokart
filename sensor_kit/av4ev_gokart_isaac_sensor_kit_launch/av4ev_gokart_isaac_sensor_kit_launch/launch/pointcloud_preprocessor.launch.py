...
def generate_launch_description():
    ...
    av4ev_gokart_isaac_sensor_kit_launch_share_dir = get_package_share_directory(
        "av4ev_gokart_isaac_sensor_kit_launch"
    )
    ...
    add_launch_arg(
        ...
        os.path.join(
            av4ev_gokart_isaac_sensor_kit_launch_share_dir,
            "config",
